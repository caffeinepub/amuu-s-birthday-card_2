...
function TeddyBear({
  ...
  return (
    ...
    >
      ...
      >
        {/* Body */}
        <ellipse cx="80" cy="130" rx="42" ry="38" fill="#D4956A" />
        {/* Tummy */}
        <ellipse cx="80" cy="132" rx="26" ry="22" fill="#F0C8A0" />
        {/* Left Arm */}
        <ellipse
          cx="40"
          cy="122"
        ...
        />
        {/* Left Leg */}
        <ellipse cx="64" cy="162" rx="13" ry="10" fill="#D4956A" />
        {/* Right Leg */}
        <ellipse cx="96" cy="162" rx="13" ry="10" fill="#D4956A" />
        {/* Left Foot */}
        <ellipse cx="60" cy="168" rx="15" ry="8" fill="#C07A50" />
        {/* Right Foot */}
        <ellipse cx="100" cy="168" rx="15" ry="8" fill="#C07A50" />
        {/* Head */}
        <circle cx="80" cy="72" r="48" fill="#D4956A" />
        {/* Left Ear */}
        <circle cx="40" cy="36" r="16" fill="#D4956A" />
        <circle cx="40" cy="36" r="9" fill="#F0C8A0" />
        {/* Right Ear */}
        <circle cx="120" cy="36" r="16" fill="#D4956A" />
        <circle cx="120" cy="36" r="9" fill="#F0C8A0" />
        {/* Face */}
        <ellipse cx="80" cy="80" rx="32" ry="28" fill="#F0C8A0" />
        {/* Left Eye */}
        <circle cx="66" cy="68" r="9" fill="#3D2B1F" />
        <circle cx="68" cy="65" r="3.5" fill="white" />
        {/* Right Eye */}
        <circle cx="94" cy="68" r="9" fill="#3D2B1F" />
        <circle cx="96" cy="65" r="3.5" fill="white" />
        {/* Eye shine */}
        <circle cx="63" cy="70" r="1.5" fill="white" opacity="0.6" />
        <circle cx="91" cy="70" r="1.5" fill="white" opacity="0.6" />
        {/* Nose */}
        <ellipse cx="80" cy="80" rx="6" ry="4" fill="#8B4513" />
        {/* Mouth */}
        <path
        ...
        />
        {/* Cheeks */}
        <ellipse cx="58" cy="82" rx="8" ry="5" fill="#FFB3C6" opacity="0.6" />
        <ellipse cx="102" cy="82" rx="8" ry="5" fill="#FFB3C6" opacity="0.6" />
        {/* Party Hat */}
        <polygon points="80,12 55,55 105,55" fill="#C9B8FF" />
        <polygon points="80,12 55,55 70,55" fill="#FFB3C6" opacity="0.7" />
        <polygon points="80,12 90,55 105,55" fill="#FFB3C6" opacity="0.7" />
        <rect x="55" y="53" width="50" height="6" rx="3" fill="#FFD4B8" />
        <polygon points="80,6 84,18 76,18" fill="#FFE066" />
        {/* Bow Tie */}
        <polygon points="72,108 80,113 72,118" fill="#FF6B9D" />
        <polygon points="88,108 80,113 88,118" fill="#FF6B9D" />
        <circle cx="80" cy="113" r="4" fill="#FF85B3" />
        {/* Teardrop */}
        {teary && (
          <>
            <ellipse
...
function SceneOpening({ onNext }: { onNext: () => void }) {
  ...
  return (
    ...
    >
      ...
      <TeddyBear message="Hiii Amuu! I've been waiting for you! 🎉 Ready for something magical? ✨" />
    </div>
  );
}
      ...
      <TeddyBear
        message={
          allBlown
            ...
            : "Make a wish, Amuu! 🕯️ Click the candles to blow them out! 💨"
        }
      />
    </div>
  );
...
function SceneCakeCutting({ onNext }: { onNext: () => void }) {
  ...
  return (
    ...
    >
      ...
      <TeddyBear message="Ooooh cake time! 🍰 You deserve every sweet bite, Amuu!" />
    </div>
  );
}
    ...
    >
      ...
      {allComplete && (
        <div style={{ textAlign: "center", marginTop: 32, zIndex: 10 }}>
          ...
          >
            See?! That's YOU, Amuu! Every. Single. Word. 💕
          </div>
          <button
            type="button"
            className="btn-cute"
    ...
    >
      ...
      >
        <TeddyBear
          message={
            hugged
              ? "Squeezing you tight, Amuu! 💕 You're the best! 🌟"
              : "Come here, Amuu... this one's from the heart. 🤗"
          }
          size={180}
          position="relative"
        />
